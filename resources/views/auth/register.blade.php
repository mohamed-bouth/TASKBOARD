    ...
    <div class="flex items-center justify-center">
        <div class="w-full">
            <div class="mb-6 text-lg text-center font-bold">
                <h1>Don't have Acco<span class="text-blue-700">unt</span></h1>
            </div>
